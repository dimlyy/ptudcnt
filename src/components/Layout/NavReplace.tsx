...
import { navItemsReplace } from "@constants";
...
const Nav = () => {
  ...
  return (
    <div className="relative w-full bg-white flex flex-col justify-center items-center pb-4 rounded-xl border border-gray-300 gap-1">
      {navItemsReplace.map((item, index) => (
