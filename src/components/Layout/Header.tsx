...
const Header = () => {
  ...
  const [onActiveNav, setOnActiveNav] = useState(false);
          ...
          <div className="lg:flex hidden flex-row m-h-[inherit] items-center justify-end mr-[-10px]">
            <div className="px-3 flex flex-row items-center">
              ...
              <div className="flex flex-col">
                <span className="text-medium text-[var(--background-color)]">
                  dimlytad@gmail.com
                </span>
                <span className="text-sm text-[var(--background-color)]">
                  +0378808834
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-row items-center h-full">
            ...
            <div className="flex user-btn relative mr-6 h-11 w-11 bg-[var(--background-color)] rounded-full">
              ...
              <div className="user-dropdown absolute z-50 top-12 right-0 w-52 min-h-16 bg-[var(--container-color)] rounded-xl shadow-2xl">
                <ul className="flex flex-col my-2 mx-3">
                  <li className="my-1">
                    <Link href="#">
                      <span className="text-sm font-light text-[var(--text-color)]">
            ...
            <div className="flex h-11 w-11 bg-[var(--btn-color)] rounded-full">
              ...
              >
                ...
                <span className="absolute top-0 right-0 w-4 h-4 rounded-full bg-[var(--btn-color)] border text-[var(--container-color)] border-slate-300 text-xs">
                  0
                </span>
              </button>
            </div>
